...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary d-flex align-items-center justify-content-between ps-2 pe-2 pt-3 pb-3">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav  m-auto mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-middle-link m-2" href="pages/empresa.jsp">Empresas</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-middle-link m-2" href="pages/browse.jsp">Empregos</a>
                        </li>
                        <li class="nav-item">
        ...
        <main>
            <section class="left-side">
                <div class="new">
                    <p>New</p>
                    <p>Fique conectado para obter os os melhores trabalhos</p>
                </div>
                <div class="find">
                    <h1>Encontre os</h1>
                    <h1>trabalhos mais interessantes do mercado</h1>
                </div>
                <div class="left-content">
                    <p>
                       Descubra os tesouros profissionais do mercado: os trabalhos mais interessantes que o aguardam! Desperte sua paix�o, desafie-se e conquiste o sucesso com oportunidades empolgantes!
                    </p>
                </div>
                <div class="search">
                    <form action="./pages/RedirecionarPesquisa.jsp">
                ...
                <div class="image-height">
                    <figure>
                        <img src="https://assets.website-files.com/63337525695d8ba70ab44222/6358b2bbb9fdec69f1b1c7a4_adam-rhodes-ep5lX958f7E-unsplash-p-2000.webp"
                             alt="" />
                        <figcaption> O mais alto que voc� possa ir. </figcaption>
                    </figure>
                </div>
            </section>
        </main>
