		...
		<div class="form-v10-content">
			<form class="form-detail" action="cadastrarEmprego.jsp" method="post" id="myform">
				...
				<div class="form-right">
					...
					<div class="form-row">
						<textarea name="descricao" id="" cols="50" rows="9" placeholder="Descrição da vaga"></textarea>
					</div>

					<div class="form-row">
						<textarea name="requisitos" id="" cols="50" rows="9" placeholder="Requisitos para a vaga"></textarea>
					</div>
